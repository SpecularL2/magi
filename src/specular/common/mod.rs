...
pub type SetL1OracleValuesInput = (U256, U256, U256, H256, H256, U256, U256);
pub const SET_L1_ORACLE_VALUES_ABI_STR: &str = r#"[
    function setL1OracleValues(uint256 _number,uint256 _timestamp,uint256 _baseFee,bytes32 _hash,bytes32 _stateRoot,uint256 _l1FeeOverhead,uint256 _l1FeeScalar) external
]"#;
