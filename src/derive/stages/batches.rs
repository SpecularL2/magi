...
use super::channels::{Channels, Channel};
...
//pub struct Batches<I> {
    ///// Mapping of timestamps to batches
    //batches: BTreeMap<u64, Batch>,
    //channel_iter: Pin<Box<dyn PurgeableStream<Item = I> + Unpin>>,
    //state: Arc<RwLock<State>>,
    //config: Arc<Config>,
//}
...
impl PurgeableStream for Batches {
    fn purge(&mut self) {
...
//}
impl Batches {
    pub fn new(channel_iter: Channels, state: Arc<RwLock<State>>, config: Arc<Config>) -> Self {
        Self {
